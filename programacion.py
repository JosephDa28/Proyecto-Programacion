...
def Prueba():
    ...
    bus = str(input("escriba el numero que quiere examinar: "))
    origen = (str(input("Escriba su estacion de origen: ")))
    destino = (str(input("Escriba su estacion de destino: ")))
    ...
    try:
        ...
        print("Escriba sin espacios y la primera letra de cada palabra en mayuscula de su origen")
        Prueba()
    try:
        posicionDestino = Lista_Rutas_Primer_Elemento.index(destino)
    except ValueError:
        print("Escriba sin espacios y la primera letra de cada palabra en mayuscula de su destino")
        Prueba()
...
Prueba()
>>>>>>> 2b1eb70953ea4c726ff220db7d2f133460bf54e7
